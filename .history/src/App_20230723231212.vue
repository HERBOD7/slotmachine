  ...
  methods: {
    spin() {
      if (this.credit) {
        ...
        console.log(
          (rolledSymbols[0].value === rolledSymbols[1].value && rolledSymbols[1].value === rolledSymbols[2].value);
        if (rolledSymbols[0].value === rolledSymbols[1].value && rolledSymbols[1].value === rolledSymbols[2].value) {
