<template>
  <div id="app">
    <div class="doors">
      <div class="door" v-for="(symbol, index) in symbols" :key="index">
    ...
    init(firstInit = true, groups = 1, duration = 1) {
      ...
      for (const door of doors) {
        ...
        if (!firstInit) {
          ...
          this.symbols = this.shuffle(this.symbols[0]);
          this.symbols = this.shuffle(this.symbols[1]);
          this.symbols = this.shuffle(this.symbols[2]);
