    ...
    spin() {
      if (this.credit) {
        ...
        for (let name in this.symbols) {
          ...
          selectedSymbols.push(shuffleArr[0]);
        }
        ...
        console.log(
          (selectedSymbols[0].value === selectedSymbols[1].value) ===
            selectedSymbols[2].value
        );
        if (
          (selectedSymbols[0].value === selectedSymbols[1].value === selectedSymbols[2].value) {
          this.credit = this.credit + selectedSymbols[0].value;
        }
